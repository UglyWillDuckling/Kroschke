...
namespace Customweb\TeleCashCw\Plugin\Framework\App;

class Http
{

	/**
	 * @var \Customweb\TeleCashCw\Model\Logging\Listener
	 */
	private $_loggingListener;

	/**
	 * @param \Customweb\TeleCashCw\Model\Logging\Listener $loggingListener
	 */
	public function __construct(
			\Customweb\TeleCashCw\Model\Logging\Listener $loggingListener
	) {
	...
	{
		\Customweb_I18n_Translation::getInstance()->addResolver(new \Customweb\TeleCashCw\Model\TranslationResolver());
	}
