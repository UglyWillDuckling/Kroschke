...
class Login extends AbstractExternalCheckout
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_TeleCashCw::externalcheckout/login.phtml';
	...
	{
		return $this->getUrl('telecashcw/externalCheckout/loginPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('telecashcw/externalCheckout/guestPost', ['_secure' => true]);
	}
	...
	{
		return $this->getUrl('telecashcw/externalCheckout/registerPost', ['_secure' => true]);
	}
