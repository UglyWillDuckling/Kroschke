...
namespace Customweb\TeleCashCw\Block\Adminhtml\Transaction;
...
class View extends \Magento\Backend\Block\Widget\Form\Container
{
	...
	protected function _construct()
	{
		...
		$this->setId('telecashcw_transaction_view');
	...
	{
		return $this->_coreRegistry->registry('telecashcw_transaction');
	}
	...
	{
		return $this->getUrl('telecashcw/transaction/update');
	}
	...
	public function getBackUrl()
	{
		...
		return $this->getUrl('telecashcw/transaction/');
	}
}