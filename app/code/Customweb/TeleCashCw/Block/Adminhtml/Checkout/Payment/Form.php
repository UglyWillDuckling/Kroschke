...
namespace Customweb\TeleCashCw\Block\Adminhtml\Checkout\Payment;

class Form extends \Magento\Backend\Block\Widget
{
	/**
	 * @var \Customweb\TeleCashCw\Model\Renderer\AdminhtmlForm
	 */
	 ...
	 * @param \Customweb\TeleCashCw\Model\Renderer\Adminhtml\CheckoutForm $formRenderer
	 * @param \Customweb\TeleCashCw\Model\Authorization\Method\Factory $authorizationMethodFactory
	 * @param array $data
	 */
	public function __construct(
			\Magento\Backend\Block\Template\Context $context,
			\Customweb\TeleCashCw\Model\Renderer\Adminhtml\CheckoutForm $formRenderer,
	...
	{
		if (!($this->authorizationMethodAdapter instanceof \Customweb\TeleCashCw\Model\Authorization\Method\AbstractMethod)) {
	 ...
	 * @return \Customweb\TeleCashCw\Block\Adminhtml\Checkout\Payment\Form
	 */
