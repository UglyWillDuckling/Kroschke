...
namespace Customweb\TeleCashCw\Block\Adminhtml\Config;
...
class Form extends \Magento\Backend\Block\Widget
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_TeleCashCw::telecashcw/config/form.phtml';

	/**
	 * @var \Customweb\TeleCashCw\Model\Config\Structure
	 */
	protected $_formStructure;

	/**
	 * @var \Customweb\TeleCashCw\Model\Renderer\Adminhtml\BackendForm
	 */
	protected $_backendFormRenderer;

	/**
	 * @param \Magento\Backend\Block\Template\Context $context
	 * @param \Customweb\TeleCashCw\Model\Config\Structure $formStructure,
	 * @param \Customweb\TeleCashCw\Model\Renderer\Adminhtml\BackendForm $backendFormRenderer
	 * @param array $data
	 */
	public function __construct(
			\Magento\Backend\Block\Template\Context $context,
			\Customweb\TeleCashCw\Model\Config\Structure $formStructure,
			\Customweb\TeleCashCw\Model\Renderer\Adminhtml\BackendForm $backendFormRenderer,
			array $data = []
	) {
