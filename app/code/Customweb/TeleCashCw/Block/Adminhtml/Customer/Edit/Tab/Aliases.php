...
namespace Customweb\TeleCashCw\Block\Adminhtml\Customer\Edit\Tab;
...
class Aliases extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Ui\Component\Layout\Tabs\TabInterface
{
    ...
    /**
     * @var \Customweb\TeleCashCw\Model\ResourceModel\Grid\PaymentMethodList
     */
     ...
     * @param \Customweb\TeleCashCw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList
    ...
    public function __construct(
    		...
    		\Customweb\TeleCashCw\Model\ResourceModel\Grid\PaymentMethodList $paymentMethodGridList,
    ...
    {
    	parent::_construct();
    	$this->setId('telecashcw_customer_alias_grid');
    ...
    {
    	return $this->getUrl('telecashcw/customer/aliases', ['_current' => true]);
    }
