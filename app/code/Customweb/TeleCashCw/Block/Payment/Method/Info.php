...
class Info extends \Magento\Payment\Block\Info
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_TeleCashCw::payment/method/info.phtml';
	...
	public function getMethod()
	{
		...
		if ($this->getTransaction() instanceof \Customweb\TeleCashCw\Model\Authorization\Transaction) {
	...
	{
		return $this->getUrl('telecashcw/transaction/view', ['transaction_id' => $this->getTransaction()->getId()]);
	}
