...
namespace Customweb\TeleCashCw\Block\Payment\Method;
...
class Form extends \Magento\Payment\Block\Form
{
	 ...
	 * @var string
	 */
	protected $_template = 'Customweb_TeleCashCw::payment/method/form.phtml';
	...
	public function getPaymentForm()
	{
		...
		$arguments = null;
		return \Customweb_Licensing_TeleCashCw_License::run('17vic94suq5i4srt', $this, $arguments);
	}

	final public function call_ugq7lvsvli7vuu2p() {
	...
	private function getFormRenderer() {
		return new \Customweb\TeleCashCw\Model\Renderer\CheckoutForm($this->getMethodCode());
	}
