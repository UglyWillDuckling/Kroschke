...
class Service implements \Customweb_Payment_ExternalCheckout_ICheckoutService
{
	...
	/**
	 * @var \Customweb\TeleCashCw\Model\ExternalCheckout\ContextFactory
	 */
	protected $_contextFactory;

	/**
	 * @var \Customweb\TeleCashCw\Helper\ExternalCheckout
	 */
	protected $_helper;
	...
	/**
	 * @var \Customweb\TeleCashCw\Model\Authorization\TransactionContextFactory
	 */
	protected $_transactionContextFactory;

	/**
	 * @var \Customweb\TeleCashCw\Model\Authorization\OrderContextFactory
	 */
	 ...
	 * @param \Customweb\TeleCashCw\Model\ExternalCheckout\ContextFactory $contextFactory
	 * @param \Customweb\TeleCashCw\Helper\ExternalCheckout $helper
	 * @param \Customweb\TeleCashCw\Model\Authorization\TransactionFactory $transactionFactory
	 * @param \Customweb\TeleCashCw\Model\Authorization\TransactionContextFactory $transactionContextFactory
	 * @param \Customweb\TeleCashCw\Model\Authorization\OrderContextFactory $orderContextFactory
	 */
	public function __construct(
			...
			\Customweb\TeleCashCw\Model\ExternalCheckout\ContextFactory $contextFactory,
			\Customweb\TeleCashCw\Helper\ExternalCheckout $helper,
			\Customweb\TeleCashCw\Model\Authorization\TransactionFactory $transactionFactory,
			\Customweb\TeleCashCw\Model\Authorization\TransactionContextFactory $transactionContextFactory,
			\Customweb\TeleCashCw\Model\Authorization\OrderContextFactory $orderContextFactory
	) {
	...
	/**
	 * @param \Customweb\TeleCashCw\Model\DependencyContainer $container
	 * @return \Customweb\TeleCashCw\Model\ExternalCheckout\Service
	 */
	public function setContainer(\Customweb\TeleCashCw\Model\DependencyContainer $container)
	{
	...
	{
		if (!($context instanceof \Customweb\TeleCashCw\Model\ExternalCheckout\Context)) {
			throw new \Customweb_Core_Exception_CastException('Customweb\TeleCashCw\Model\ExternalCheckout\Context');
		}
	...
	public function authenticate(\Customweb_Payment_ExternalCheckout_IContext $context, $emailAddress, $successUrl)
	{
		...
		if ($this->_checkoutHelper->isAllowedGuestCheckout($context->getQuote())
				&& $this->_scopeConfig->getValue('telecashcw/shop/external_checkout_account_creation') == 'skip_selection') {
			...
			$context->setRegisterMethod(\Customweb\TeleCashCw\Model\ExternalCheckout\Context::REGISTER_METHOD_GUEST);
		...
		$context->save();
		return \Customweb_Core_Http_Response::redirect($context->getQuote()->getStore()->getUrl('telecashcw/externalCheckout/login', ['_secure' => true]));
	}
	...
	public function renderShippingMethodSelectionPane(\Customweb_Payment_ExternalCheckout_IContext $context, $errorMessages)
	{
		...
		return $this->_layoutFactory->create()->createBlock('Customweb\TeleCashCw\Block\ExternalCheckout\ShippingMethods')
			->setContext($context)
	...
	public function renderReviewPane(\Customweb_Payment_ExternalCheckout_IContext $context, $renderConfirmationFormElements, $errorMessage)
	{
		...
		$layout->getUpdate()->load(['telecashcw_externalcheckout_review']);
		$layout->generateXml();
		$layout->generateElements();
		$layout->getBlock('customweb_telecashcw_externalcheckout_review')
			->setContext($context)
	...
	public function createOrder(\Customweb_Payment_ExternalCheckout_IContext $context)
	{
		...
		try {
			...
			/* @var $transaction \Customweb\TeleCashCw\Model\Authorization\Transaction */
			$transaction = $this->_coreRegistry->registry('telecashcw_transaction');
