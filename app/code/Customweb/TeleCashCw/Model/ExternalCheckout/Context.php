...
namespace Customweb\TeleCashCw\Model\ExternalCheckout;

/**
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setContextId(string $value)
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setState(string $value)
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setFailedErrorMessage(string $value)
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setCartUrl(string $value)
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setDefaultCheckoutUrl(string $value)
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setInvoiceItems(\Customweb_Payment_Authorization_IInvoiceItem[] $value)
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setOrderAmountInDecimals(double $value)
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setCurrencyCode(string $value)
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setLanguageCode(string $value)
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setCustomerEmailAddress(string $value)
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setCustomerId(int $value)
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setTransactionId(int $value)
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setShippingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setBillingAddress(\Customweb_Payment_Authorization_OrderContext_IAddress $value)
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setShippingMethodName(string $value)
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setPaymentMethod(string $value)
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setProviderData(array $value)
 * @method string getCreatedOn()
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setCreatedOn(string $value)
 * @method string getUpdatedOn()
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setUpdatedOn(string $value)
 * @method string getSecurityToken()
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setSecurityToken(string $value)
 * @method string getSecurityTokenExpiryDate()
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setSecurityTokenExpiryDate(string $value)
 * @method string getAuthenticationSuccessUrl()
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setAuthenticationSuccessUrl(string $value)
 * @method string getAuthenticationEmailAddress()
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setAuthenticationEmailAddress(string $value)
 * @method int getQuoteId()
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setQuoteId(int $value)
 * @method string getRegisterMethod()
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setRegisterMethod(string $value)
 * @method int getStoreId()
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setStoreId(int $value)
 * @method int getVersionNumber()
 * @method \Customweb\TeleCashCw\Model\ExternalCheckout\Context setVersionNumber(int $value)
 */
class Context extends \Magento\Framework\Model\AbstractModel implements \Customweb_Payment_ExternalCheckout_IContext
{
	...
	/**
	 * @var \Customweb\TeleCashCw\Helper\InvoiceItem
	 */
	protected $_invoiceItemHelper;

	/**
	 * @var \Customweb\TeleCashCw\Helper\FoomanSurcharge
	 */
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_telecashcw_external_checkout_context';
	...
	/**
	 * @var \Customweb\TeleCashCw\Model\Payment\Method\AbstractMethod
	 */
	 ...
	 * @param \Customweb\TeleCashCw\Helper\InvoiceItem $invoiceItemHelper
	 * @param \Customweb\TeleCashCw\Helper\FoomanSurcharge $foomanSurchargeHelper
	...
	public function __construct(
			...
			\Customweb\TeleCashCw\Helper\InvoiceItem $invoiceItemHelper,
			\Customweb\TeleCashCw\Helper\FoomanSurcharge $foomanSurchargeHelper,
    ...
    protected function _construct() {
        $this->_init('Customweb\TeleCashCw\Model\ResourceModel\ExternalCheckout\Context');
    }
     ...
     *
     * @param int $quoteId
     * @return \Customweb\TeleCashCw\Model\ExternalCheckout\Context
     */
    ...
    {
    	if (!($this->cachedPaymentMethod instanceof \Customweb\TeleCashCw\Model\Payment\Method\AbstractMethod)) {
    		try {
    ...
    /**
     * @param string|\Customweb\TeleCashCw\Model\Payment\Method\AbstractMethod $paymentMethod
     * @return \Customweb\TeleCashCw\Model\ExternalCheckout\Context
     */
    public function setPaymentMethod($paymentMethod)
    {
    	if ($paymentMethod instanceof \Customweb\TeleCashCw\Model\Payment\Method\AbstractMethod) {
    ...
    public function updateQuote(\Magento\Quote\Model\Quote $quote = null)
    {
		...
		if ($this->getPaymentMethod() instanceof \Customweb\TeleCashCw\Model\Payment\Method\AbstractMethod) {
			$data = [
