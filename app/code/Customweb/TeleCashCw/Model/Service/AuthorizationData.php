...
class AuthorizationData implements \Customweb\TeleCashCw\Api\Data\AuthorizationDataInterface {
	...
	public function setHiddenFormFields(array $hiddenFormFields)
	{
		...
		foreach ($hiddenFormFields as $key => $value) {
			$field = new \Customweb\TeleCashCw\Model\Service\AuthorizationFormField();
