...
class CheckoutManagement implements \Customweb\TeleCashCw\Api\CheckoutManagementInterface
{
	/**
	...
	/**
	 *
	 * @var \Customweb\TeleCashCw\Model\Payment\Method\ConfigProvider
	 */
	 ...
	 * @param \Customweb\TeleCashCw\Model\Payment\Method\ConfigProvider $configProvider
	...
	public function __construct(
		...
		\Customweb\TeleCashCw\Model\Payment\Method\ConfigProvider $configProvider,
     ...
     * @param int $alias
     * @return string
     * @throws \Customweb\TeleCashCw\Model\Exception\OptimisticLockingException
     */
    protected function buildPaymentForm($quoteId, $paymentMethod, $alias = null)
    {
	    	...
	    	for ($i = 0; $i < 10; $i++) {
	    		...
	    		catch (\Customweb\TeleCashCw\Model\Exception\OptimisticLockingException $e) {
	    			// Try again.
	    			$lastException = $e;
	    		}
	    	}
    ...
    /**
     *
     * @param \Customweb\TeleCashCw\Api\Data\AuthorizationFormFieldInterface[] $formValues
     * @return NULL|string[]
     */
    protected function convertFormValuesToMap(array $formValues = null) {
    		...
    		foreach ($formValues as $formValue) {
    			/* @var \Customweb\TeleCashCw\Api\Data\AuthorizationFormFieldInterface $formValue */
