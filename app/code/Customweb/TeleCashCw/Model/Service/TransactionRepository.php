...
class TransactionRepository implements \Customweb\TeleCashCw\Api\TransactionRepositoryInterface
{
	/**
    ...
    /**
     * @var \Customweb\TeleCashCw\Api\Data\TransactionInterfaceFactory
     */
	 ...
	 * @param \Customweb\TeleCashCw\Api\Data\TransactionInterfaceFactory $transactionDataFactory
	...
	public function __construct(
			...
			\Customweb\TeleCashCw\Api\Data\TransactionInterfaceFactory $transactionDataFactory,
	...
	public function getList(\Magento\Framework\Api\SearchCriteriaInterface $searchCriteria)
	{
		...
		/** @var \Customweb\TeleCashCw\Model\ResourceModel\Authorization\Transaction\Collection $collection */
	 ...
	 *
	 * @return \Customweb\TeleCashCw\Api\Data\TransactionInterface
	 */
	protected function getDataModel(\Customweb\TeleCashCw\Model\Authorization\Transaction $transaction)
	{
		$transactionDataObject = $this->_transactionDataFactory->create();
		$this->_dataObjectHelper->populateWithArray(
				$transactionDataObject,
				$this->extractTransactionData($transaction),
				'\Customweb\TeleCashCw\Api\Data\TransactionInterface'
		);
		return $transactionDataObject;
	}

	private function extractTransactionData(\Customweb\TeleCashCw\Model\Authorization\Transaction $transaction)
	{
		...
		$data[\Customweb\TeleCashCw\Api\Data\TransactionInterface::TRANSACTION_DATA] = $transactionData;
		return $data;
	}
