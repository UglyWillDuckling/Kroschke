...
namespace Customweb\TeleCashCw\Model\Renderer\Adminhtml;

class CheckoutForm extends \Customweb\TeleCashCw\Model\Renderer\AbstractForm
{
	/**
	...
	public function __construct(
		...
		$this->setControlCssClassResolver(new \Customweb\TeleCashCw\Model\Renderer\Adminhtml\ControlCssClassResolver());

		$this->setFormCssClass('telecashcw_form');
