...
namespace Customweb\TeleCashCw\Model\Logging;
...
class Listener implements \Customweb_Core_Logger_IListener {
	 ...
	 * @var string
	 */
	protected $fileName = '/var/log/telecashcw.log';
	...
	public function __construct(
		...
		$this->_logger = new Logger('telecashcw');
	...
	private function isLevelActive($level) {
		switch ($this->_scopeConfig->getValue('telecashcw/logging/level')) {
			case 'debug':
				return true;
			case 'info':
