 ...
 * @method \Customweb\TeleCashCw\Model\Authorization\CustomerContext setContextId(string $value)
 * @method string getCustomerId()
 * @method \Customweb\TeleCashCw\Model\Authorization\CustomerContext setCustomerId(string $value)
 * @method array getValues()
 * @method \Customweb\TeleCashCw\Model\Authorization\CustomerContext setValues(array $value)
 * @method int getVersionNumber()
 * @method \Customweb\TeleCashCw\Model\Authorization\CustomerContext setVersionNumber(int $value)
 */
class CustomerContext extends \Magento\Framework\Model\AbstractModel implements \Customweb_Payment_Authorization_IPaymentCustomerContext
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_telecashcw_customer_context';
	 ...
	 * @param \Customweb\TeleCashCw\Model\Authorization\CustomerContextFactory $factory
	...
	public function __construct(
			...
			\Customweb\TeleCashCw\Model\Authorization\CustomerContextFactory $factory,
    ...
    {
        $this->_init('Customweb\TeleCashCw\Model\ResourceModel\Authorization\CustomerContext');
     ...
     * @return \Customweb\TeleCashCw\Model\Authorization\CustomerContext
     */
