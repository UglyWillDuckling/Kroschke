...
class TransactionHandler implements \Customweb_Payment_ITransactionHandler
{
	 ...
	 * @param mixed $value
	 * @param string $field
	 * @return null|\Customweb\TeleCashCw\Model\Authorization\Transaction
	 */
	 ...
	 */
	private function storeInCache(\Customweb\TeleCashCw\Model\Authorization\Transaction $transaction)
	{
