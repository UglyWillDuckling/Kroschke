...
class Factory
{
     ...
     */
    public function create(\Customweb\TeleCashCw\Model\Authorization\Method\Context\IContext $context)
    {
    	if ($context->isMoto()) {
    ...
    /**
     * @param \Customweb\TeleCashCw\Model\Authorization\Method\Context\IContext $context
     * @return \Customweb\TeleCashCw\Model\Authorization\Method\Moto
     */
    public function createMoto(\Customweb\TeleCashCw\Model\Authorization\Method\Context\IContext $context)
    {
    	return $this->_objectManager->create('\\Customweb\\TeleCashCw\\Model\\Authorization\\Method\\Moto', ['context' => $context]);
    }

    /**
     * @return \Customweb\TeleCashCw\Model\Authorization\Method\Context\Factory
     */
