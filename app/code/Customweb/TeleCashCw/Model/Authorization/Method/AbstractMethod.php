...
namespace Customweb\TeleCashCw\Model\Authorization\Method;
...
abstract class AbstractMethod
{
	...
	/**
	 * @var \Customweb\TeleCashCw\Model\ResourceModel\Authorization\Transaction\CollectionFactory
	 */
	protected $_transactionCollectionFactory;

	/**
	 * @var \Customweb\TeleCashCw\Model\Authorization\Method\Context\Factory
	 */
	...
	/**
	 * @var \Customweb\TeleCashCw\Model\Authorization\Method\Context\IContext
	 */
	private $context;
	 ...
	 * @param \Customweb\TeleCashCw\Model\ResourceModel\Authorization\Transaction\CollectionFactory $transactionCollectionFactory
	 * @param \Customweb\TeleCashCw\Model\Authorization\Method\Context\Factory $contextFactory
	 * @param \Customweb\TeleCashCw\Model\Authorization\Method\Context\IContext $context
	 */
	public function __construct(
			...
			\Customweb\TeleCashCw\Model\ResourceModel\Authorization\Transaction\CollectionFactory $transactionCollectionFactory,
			\Customweb\TeleCashCw\Model\Authorization\Method\Context\Factory $contextFactory,
			\Customweb\TeleCashCw\Model\Authorization\Method\Context\IContext $context
	...
	/**
	 * @return \Customweb\TeleCashCw\Model\Authorization\Method\Context\IContext
	 */
	public function getContext()
	{
		if (!($this->context instanceof \Customweb\TeleCashCw\Model\Authorization\Method\Context\IContext)) {
	 ...
	 * @param \Customweb\TeleCashCw\Model\Authorization\Method\Context\IContext $context
	 */
	public function setContext(\Customweb\TeleCashCw\Model\Authorization\Method\Context\IContext $context)
	{
		$this->context = $context;
	}
	...
	public function initializeTransaction(\Customweb\TeleCashCw\Model\Authorization\Transaction $transaction)
	{
		...
		$this->_checkoutSession->unsTeleCashCwCheckoutId();
	...
	/**
	 * @return \Customweb\TeleCashCw\Model\Service\AuthorizationData
	 */
	public function startAuthorization()
	{
		$data = new \Customweb\TeleCashCw\Model\Service\AuthorizationData();
	...
	public function finishAuthorization()
	{
		if ($this->getContext()->getTransaction()->getTransactionObject()->isAuthorized()) {
			if ($this->getContext()->getPaymentMethod() instanceof \Customweb\TeleCashCw\Model\Payment\Method\AbstractMethod) {
				$this->_coreRegistry->register('telecashcw_authorization_transaction', $this->getContext()->getTransaction());
	...
	/**
	 * @return \Customweb\TeleCashCw\Model\Authorization\Transaction|null
	 */
