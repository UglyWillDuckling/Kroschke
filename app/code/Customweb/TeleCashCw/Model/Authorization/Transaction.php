...
namespace Customweb\TeleCashCw\Model\Authorization;

use \Customweb\TeleCashCw\Api\Data\TransactionInterface;

/**
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setEntityId(int $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setTransactionExternalId(string $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setOrderId(int $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setOrderIncrementId(string $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setOrderPaymentId(int $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setAliasForDisplay(string $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setAliasActive(boolean $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setPaymentMethod(string $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setTransactionObject(\Customweb_Payment_Authorization_ITransaction $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setAuthorizationType(string $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setCustomerId(int $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setUpdatedOn(string $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setCreatedOn(string $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setPaymentId(string $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setExecuteUpdateOn(string $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setAuthorizationAmount(float $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setAuthorizationStatus(string $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setPaid(boolean $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setLiveTransaction(boolean $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setCurrency(string $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setSendEmail(boolean $value)
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setStoreId(int $value)
 * @method int getVersionNumber()
 * @method \Customweb\TeleCashCw\Model\Authorization\Transaction setVersionNumber(int $value)
 */
class Transaction extends \Magento\Framework\Model\AbstractModel implements \Magento\Sales\Model\EntityInterface, TransactionInterface
{
	 ...
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_telecashcw_transaction';
	 ...
	 * @var string
	 */
	protected $_entityType = 'telecashcw_transaction';
	...
	/**
	 * @var \Customweb\TeleCashCw\Model\DependencyContainer
	 */
	protected $_container;

	/**
	 * @var \Customweb\TeleCashCw\Model\Authorization\Method\Factory
	 */
	 ...
	 * @param \Customweb\TeleCashCw\Model\DependencyContainer $container
	 * @param \Customweb\TeleCashCw\Model\Authorization\Method\Factory $authorizationMethodFactory
	...
	public function __construct(
			...
			\Customweb\TeleCashCw\Model\DependencyContainer $container,
			\Customweb\TeleCashCw\Model\Authorization\Method\Factory $authorizationMethodFactory,
	...
	{
		$this->_init('Customweb\TeleCashCw\Model\ResourceModel\Authorization\Transaction');
	}
	...
	public function afterSave()
	{
		...
		if ($this->getTransactionObject() !== null && $this->getTransactionObject() instanceof \Customweb_Payment_Authorization_ITransaction) {
			...
			if ($customerContext instanceof \Customweb\TeleCashCw\Model\Authorization\CustomerContext) {
				try {
		...
		if ($this->_registry->registry('initializeTransaction') !== false && $this->getTransactionObject() == null) {
			...
			/* @var $adapter \Customweb\TeleCashCw\Model\Authorization\Method\AbstractMethod */
