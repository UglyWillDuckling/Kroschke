...
namespace Customweb\TeleCashCw\Model\Alias;

class Handler
{
	/**
	 * @var \Customweb\TeleCashCw\Model\ResourceModel\Authorization\Transaction\Collection
	 */
	 ...
	 */
	public function getAliasTransactions(\Customweb\TeleCashCw\Model\Authorization\OrderContext $orderContext)
	{
	 ...
	 */
	public function removeSimilarAliases(\Customweb\TeleCashCw\Model\Authorization\Transaction $transaction)
	{
	 ...
	 * @throws \Exception
	 */
	public function removeAlias(\Customweb\TeleCashCw\Model\Authorization\Transaction $transaction)
	{
	 ...
	 * @throws Exception
	 */
	public function deactivateAlias(\Customweb\TeleCashCw\Model\Authorization\Transaction $transaction)
	{
		$transaction->setAliasActive(false);
		$transaction->save();
	}
