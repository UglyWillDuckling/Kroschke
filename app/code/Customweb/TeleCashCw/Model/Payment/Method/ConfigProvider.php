...
class ConfigProvider implements \Magento\Checkout\Model\ConfigProviderInterface
{
        ...
        public function getForm(AbstractMethod $method, \Magento\Quote\Model\Quote $quote = null, $alias = null)
    {
		...
		return \Customweb_Licensing_TeleCashCw_License::run('rm3p80np0e18n4t7', $this, $arguments);
	}

	final public function call_hita0kuhhcqc04q5() {
    ...
    protected function getFailureMessage(AbstractMethod $method)
    {
    	if ($this->_checkoutSession->getQuote()->getPayment()->getMethod() == $method->getCode()) {
	    	$failureMessage = $this->_checkoutSession->getTeleCashCwFailureMessage();
	    	if (!empty($failureMessage)) {
	    		$this->_checkoutSession->unsTeleCashCwFailureMessage();
    ...
    protected function getImageUrl(AbstractMethod $method)
    {
    	try {
    		...
    		return $this->_assetRepo->getUrlWithParams('Customweb_TeleCashCw/images/payment/method/' . $method->getPaymentMethodName() . '.png', $params);
    ...
    {
    	return new \Customweb\TeleCashCw\Model\Renderer\CheckoutForm($method->getCode());
    }
