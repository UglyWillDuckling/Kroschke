 ...
 *
 */
namespace Customweb\TeleCashCw\Model\Payment\Method;
...
class AbstractMethod extends \Magento\Payment\Model\Method\AbstractMethod implements \Customweb_Payment_Authorization_IPaymentMethod
{
	...
	/**
	 *
	 * @var \Customweb\TeleCashCw\Model\Configuration
	 */
	 ...
	 * @var string
	 */
	protected $_formBlockType = 'Customweb\TeleCashCw\Block\Payment\Method\Form';
	 ...
	 * @var string
	 */
	protected $_infoBlockType = 'Customweb\TeleCashCw\Block\Payment\Method\Info';
	 ...
	 * @param \Customweb\TeleCashCw\Model\Configuration $configuration
	...
	public function __construct(
			...
			\Customweb\TeleCashCw\Model\Configuration $configuration,
	...
	public function getOrderPlaceRedirectUrl()
	{
		...
		$transactionId = null;
		$transaction = $this->_registry->registry('telecashcw_transaction');
		if ($transaction instanceof \Customweb\TeleCashCw\Model\Authorization\Transaction) {
			$transactionId = $transaction->getId();
		}
		return $quote->getStore()->getUrl('telecashcw/checkout/error', [
			'_secure' => true,
	...
	public function validate()
	{
		...
		$arguments = null;
		return \Customweb_Licensing_TeleCashCw_License::run('c1fmg2m5q3eocq0c', $this, $arguments);
	}

	final public function call_9u3dr5de9hc5bqm3() {
	 ...
	 * @return \Customweb\TeleCashCw\Model\Payment\Method\AbstractMethod
	 */
	...
	public function authorize(\Magento\Payment\Model\InfoInterface $payment, $amount)
	{
		...
		$transaction = $this->_registry->registry('telecashcw_authorization_transaction');
		if ($transaction instanceof \Customweb\TeleCashCw\Model\Authorization\Transaction) {
	...
	private function captureItems(\Customweb\TeleCashCw\Model\Authorization\Transaction $transaction, $items = [])
	{
