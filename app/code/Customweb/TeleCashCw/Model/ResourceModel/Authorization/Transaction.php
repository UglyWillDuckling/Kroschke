...
namespace Customweb\TeleCashCw\Model\ResourceModel\Authorization;

class Transaction extends \Customweb\TeleCashCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_telecashcw_transaction_resource';
	...
	public function unserializeTransactionObject(\Customweb\TeleCashCw\Model\Authorization\Transaction $transaction){
    ...
    {
        $this->_init('customweb_telecashcw_transaction', 'entity_id');
    }
