...
namespace Customweb\TeleCashCw\Model\ResourceModel\ExternalCheckout;

class Context extends \Customweb\TeleCashCw\Model\ResourceModel\AbstractVersionedModel
{
	/**
	 * Event prefix
	 *
	 * @var string
	 */
	protected $_eventPrefix = 'customweb_telecashcw_external_checkout_context_resource';
    ...
    {
        $this->_init('customweb_telecashcw_external_checkout_context', 'context_id');
    }
