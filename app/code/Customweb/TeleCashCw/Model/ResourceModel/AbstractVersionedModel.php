...
namespace Customweb\TeleCashCw\Model\ResourceModel;
		...
		*/
		if ($this->_isPkAutoIncrement) {
			...
			if (!empty($data)) {
				...
				if($rowAffected == 0) {
					throw new \Customweb\TeleCashCw\Model\Exception\OptimisticLockingException(get_class($object), $object->getId());
				}
