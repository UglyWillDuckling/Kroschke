...
namespace Customweb\TeleCashCw\Observer\ExternalCheckout;
...
{
	/**
	 * @var \Customweb\TeleCashCw\Model\ExternalCheckout\Widget\Collection
	 */
	protected $_widgetCollection;

	/**
	 * @param \Customweb\TeleCashCw\Model\ExternalCheckout\Widget\Collection $widgetCollection
	 */
	public function __construct(
			\Customweb\TeleCashCw\Model\ExternalCheckout\Widget\Collection $widgetCollection
	) {
