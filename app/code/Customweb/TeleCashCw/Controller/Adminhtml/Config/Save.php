...
namespace Customweb\TeleCashCw\Controller\Adminhtml\Config;

class Save extends \Customweb\TeleCashCw\Controller\Adminhtml\Config
{
	...
	private function storeConfigState()
	{
		...
		$storedConfigState = $storage->read(\Customweb\TeleCashCw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_SPACE,
				\Customweb\TeleCashCw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_STATE_KEY);
		...
		$storage->write(\Customweb\TeleCashCw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_SPACE,
				\Customweb\TeleCashCw\Model\Renderer\Adminhtml\BackendForm::STORAGE_CONFIG_STATE_KEY, $updatedConfigState);
	}
