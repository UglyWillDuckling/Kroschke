...
class Widget extends \Customweb\TeleCashCw\Controller\Checkout
{
	public function execute()
	{
		$context = $this->_authorizationMethodFactory->getContextFactory()->createTransaction();
		/* @var $authorizationMethodAdapter \Customweb\TeleCashCw\Model\Authorization\Method\Widget */
		...
		$resultPage->getLayout()
			->getBlock('customweb_telecashcwcheckout_widget')
