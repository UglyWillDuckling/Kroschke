...
namespace Customweb\TeleCashCw\Controller;
...
abstract class Checkout extends \Magento\Framework\App\Action\Action
{
	 ...
	 */
	protected function handleSuccess(\Customweb\TeleCashCw\Model\Authorization\Transaction $transaction)
	{
	 ...
	 */
	protected function handleFailure(\Customweb\TeleCashCw\Model\Authorization\Transaction $transaction, $errorMessage)
	{
		$this->_checkoutSession->setLastRealOrderId($transaction->getOrder()->getRealOrderId());
		$this->restoreQuote();

		$this->messageManager->addErrorMessage($errorMessage);
// 		$this->_checkoutSession->setTeleCashCwFailureMessage($errorMessage);
