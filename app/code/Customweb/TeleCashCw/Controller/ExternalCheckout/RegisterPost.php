...
namespace Customweb\TeleCashCw\Controller\ExternalCheckout;

class RegisterPost extends \Customweb\TeleCashCw\Controller\ExternalCheckout
{
	/**
	...
	{
		if (!($this->getContext() instanceof \Customweb\TeleCashCw\Model\ExternalCheckout\Context) || !$this->getContext()->getId()) {
		...
		if ($this->getRequest()->isPost()) {
			$this->getContext()->setRegisterMethod(\Customweb\TeleCashCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER);
			...
			if (true !== ($result = $this->_helper->validateCustomerData($this->getQuote(), $data, \Customweb\TeleCashCw\Model\ExternalCheckout\Context::REGISTER_METHOD_REGISTER))) {
