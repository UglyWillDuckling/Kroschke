 ...
 * @Bean
 */
class Customweb_TeleCash_BackendOperation_Adapter_CaptureAdapter extends Customweb_TeleCash_AbstractAdapter implements 
	...
	public function partialCapture(Customweb_Payment_Authorization_ITransaction $transaction, $items, $close){
		...
		Customweb_TeleCash_Util::setTxTypeForPaymentMethod($paymentMethod, Customweb_TeleCash_IConstants::OPERATION_CAPTURE, 
				$ipgTransaction);
		...
		$service->setClientCertificate(Customweb_TeleCash_Util::getCertificate($this->getConfiguration(), $transaction->isMoto()))->setClientCertificatePassphrase(
