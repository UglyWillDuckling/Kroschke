 ...
 */
class Customweb_TeleCash_Method_Klarna_Invoice extends Customweb_TeleCash_Method_Klarna_Abstract {
	...
	private function getConditionsElement(Customweb_Payment_Authorization_IOrderContext $orderContext){
		$conditionElementId = 'telecash-klarna-conditions-' . uniqid();
		$consentElementId = 'telecash-klarna-consent-' . uniqid();
	...
	public function getServerAPIOrderRequest(Customweb_TeleCash_Authorization_Transaction $transaction, array $formData){
