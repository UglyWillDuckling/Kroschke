 ...
 * @Method()
 */
class Customweb_TeleCash_Method_DefaultMethod extends Customweb_Payment_Authorization_AbstractPaymentMethodWrapper {
	...
	public function __construct(Customweb_Payment_Authorization_IPaymentMethod $paymentMethod, Customweb_DependencyInjection_IContainer $container){
		...
		if (!($container instanceof Customweb_TeleCash_Container)) {
			$container = new Customweb_TeleCash_Container($container);
		}
	...
	public function getCapturingMode($transaction){
		if (!$this->existsPaymentMethodConfigurationValue('capturing') ||
			...
			return Customweb_TeleCash_IConstants::OPERATION_SALE;
		}
		else {
