 ...
 *
 */
class Customweb_TeleCash_Container extends Customweb_Payment_AbstractContainer {
	...
	public function getConfiguration(){
		return $this->getBean('Customweb_TeleCash_Configuration');
	}
	...
	public function getMethodFactory(){
		return $this->getBean('Customweb_TeleCash_Method_Factory');
	}
	 ...
	 * @return Customweb_TeleCash_Method_DefaultMethod
	 */
	 ...
	 * @return Customweb_TeleCash_Method_DefaultMethod
	 */
	public function getPaymentMethodByTransaction(Customweb_TeleCash_Authorization_Transaction $transaction){
