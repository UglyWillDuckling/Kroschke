...
class Customweb_TeleCash_Authorization_PaymentPage_ParameterBuilder extends Customweb_TeleCash_Authorization_AbstractParameterBuilder {
	...
	public function buildParameters(){
		...
		$parameters['hashExtended'] = Customweb_TeleCash_Util::calculateExtendedHash($parameters,
