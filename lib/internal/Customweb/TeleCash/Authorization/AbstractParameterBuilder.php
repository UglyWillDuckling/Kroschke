...
abstract class Customweb_TeleCash_Authorization_AbstractParameterBuilder extends Customweb_TeleCash_AbstractParameterBuilder {
	
	private $formData = array();
	
	/**
	 *
	 * @var Customweb_TeleCash_Authorization_Transaction
	 */
	...
	/**
	 *
	 * @return Customweb_TeleCash_Authorization_Transaction
	 */
	...
	protected function getProcessAuthorizationUrl(){
		...
		// TeleCash is encoding the string on there side again. If we pass it in proper
