...
class Customweb_TeleCash_Authorization_Hidden_Adapter extends Customweb_TeleCash_Authorization_AbstractAdapter 
	...
	public function getHiddenFormFields(Customweb_Payment_Authorization_ITransaction $transaction) {
		$builder = new Customweb_TeleCash_Authorization_Hidden_ParameterBuilder($transaction, $this->getContainer(), array());
	...
	public function getFormActionUrl(Customweb_Payment_Authorization_ITransaction $transaction) {
		return $this->getConfiguration()->getBaseUrl().Customweb_TeleCash_IConstants::URL_CONNECT;
